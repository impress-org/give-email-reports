...
<table style="text-align: center !important; width: 100%; table-layout: fixed;">
		...
		<td colspan="3" style="padding: 16px;">
			<h1 style="font-size: 48px; line-height: 1em; margin: 0; color:#4EAD61;">
				<?php if ( give_get_option( 'currency_position' ) == 'before' ): ?>
					<span
						style="font-size: 20px; vertical-align: super;"><?php echo give_currency_filter( '' ); ?></span><?php endif; ?><?php echo give_email_reports_total('daily'); ?>
	...
	<tr>
		<td style="padding: 30px; text-align: center;">
			<span
				style="display: block; font-size:22px; font-weight: bold;color:#4EAD61;"><?php echo give_email_reports_weekly_total(); ?></span>
